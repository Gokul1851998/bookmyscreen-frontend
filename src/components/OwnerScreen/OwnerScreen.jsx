...
import { addScreen, deleteScreen, editScreen, getScreen } from '../../api/owner/ownerInstance';
...
function OwnerScreen() {
  ...
  return (
    ...
    <button onClick={toggleModal} className=" bg-green-600 hover:bg-green-500 text-white font-semibold hover:text-white py-2 px-4 border border-blue-500 hover:border-transparent rounded" >Add</button>
  </div>
  ...
  <thead className="bg-gray-900 text-white">
    <tr>
      ...
      <th className="px-6 py-4 text-left font-semibold uppercase">Screen Number</th>
      <th className="px-6 py-4 text-left font-semibold uppercase">Rows</th>
      <th className="px-6 py-4 text-center font-semibold uppercase">Columns</th>
      <th className="px-6 py-4 text-center font-semibold uppercase">Total Seats</th>
    ...
    {screens.map((list,index)=>(
      ...
      {showModal && (
        ...
        <div className=" m-3 grid gap-6 mb-2 ">
          <div>
            <label htmlFor="first_name" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Screen Number</label>
            <input type="number" onChange={(e)=>setScreen(e.target.value)} id="first_name" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:border-gray-600 dark:placeholder-gray-400 dark:text-dark dark:focus:ring-blue-500 dark:focus:border-blue-500"  required />
          </div>
          <div>
            <label htmlFor="last_name" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Number of Rows</label>
            <input type="number" onChange={(e)=>setRows(e.target.value)} id="last_name" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:border-gray-600 dark:placeholder-gray-400 dark:text-dark dark:focus:ring-blue-500 dark:focus:border-blue-500"  required />
          </div>
          <div>
            <label htmlFor="company" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Number of Columns</label>
            <input type="number" onChange={(e)=>setColumns(e.target.value)} id="company" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:border-gray-600 dark:placeholder-gray-400 dark:text-dark dark:focus:ring-blue-500 dark:focus:border-blue-500" required />
          </div>  
        </div>
