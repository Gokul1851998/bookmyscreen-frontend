              ...
              activeOrders.map((order) => (
                <div key={order._id} className="food-card food-card--vertical">
                  <div className="food-card_img">
                    <img
                      src={`https://image.tmdb.org/t/p/w300/${order.image}`}
                      alt=""
                    />
                  </div>
                  <div className="food-card_content">
                    <div className="food-card_title-section">
                      ...
                      >
                        {order.movieName} ({order.language})
                      </a>
                    ...
                    <div className="food-card_bottom-section">
                      ...
                      <div className="space-between">
                        <h2>
                          Qyt: <b>{order.selectedSeats.length}</b>
                        </h2>
                    ...
                    {order.status === "Booked" ? (
                      <div className="food-card_button-section">
                        <button
                          ...
                          onClick={() => handelTicket(order._id)}
                          className="badge badge-success text-md mr-2"
                        >
                          View Ticket
                        </button>
                        <button
                          ...
                          className="badge badge-danger text-md mt-2"
                        >
                          Cancel
                        </button>
                      </div>
                      ...
                      <button
                        style={{ width: "80px", height: "30px" }}
                        className="badge badge-danger text-md mt-2 w-100"
                      >
                        Canceled
                      </button>
                    )}
                ...
                >
                  ...
                  <div className="food-card_content">
                    ...
                    {order.paymentstatus === "Expired" ? (
                      <button
                        style={{ width: "80px", height: "30px" }}
                        className="badge badge-warning text-white text-md mt-2 w-100"
                      >
                        Expired
                      </button>
                    ) : null}
