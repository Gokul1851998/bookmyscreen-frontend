  ...
  return (
    <>
      ...
      <div 
        id="sidebar"
        ref={sidebar}
        className={`flex flex-col absolute z-40 left-0 top-0 lg:static lg:left-auto lg:top-auto lg:translate-x-0   lg:overflow-y-auto  w-64 lg:w-20 lg:sidebar-expanded:!w-64 2xl:!w-64 shrink-0 bg-slate-800 p-4 transition-all duration-200 ease-in-out ${
                  ...
                  return (
                    <React.Fragment>
                      <a style={{ cursor: 'pointer' }}
                        ...
                        onClick={()=>{navigate('/admin/adminMovies')}}
                      >
                        <div className="flex items-center justify-between">
                          <div className="flex items-center">
                            <svg className="shrink-0 h-6 w-6" viewBox="0 0 24 24">
                            ...
                            <span className="text-sm font-medium ml-3 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200" style={{color:'white'}}>
                              Movie Management
                            </span>
                          </div>
                  ...
                  return (
                    <React.Fragment>
                      <a style={{ cursor: 'pointer' }}
                        ...
                        onClick={()=>{navigate('/admin/adminOwners')}}
                      >
                        <div className="flex items-center justify-between">
                          <div className="flex items-center">
                            <svg className="shrink-0 h-6 w-6" viewBox="0 0 24 24">
                    ...
                    <React.Fragment>
                      <a
                       style={{ cursor: 'pointer' }}
                        ...
                        onClick={()=>{navigate('/admin/sails-report')}}
                      >
                        <div className="flex items-center justify-between">
                          <div className="flex items-center">
                            <svg className="shrink-0 h-6 w-6" viewBox="0 0 24 24">
