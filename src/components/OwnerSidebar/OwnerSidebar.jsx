...
function OwnerSidebar({ sidebarOpen, setSidebarOpen }) {
                  ...
                  return (
                    <React.Fragment>
                      <a
                        ...
                        onClick={()=>{navigate('/owner/ownerHome')}}
                      >
                      ...
                      >
                        <div className="flex items-center justify-between">
                          <div className="flex items-center">
                            ...
                            <span style={{color:'white'}} className="text-sm font-medium ml-3 lg:sidebar-expanded:opacity-100  duration-200">
                              Screen Management
                            </span>
                          </div>
                  ...
                  return (
                    <React.Fragment>
                      <a
                        ...
                        onClick={()=>{navigate('/owner/owner-sailsReport')}}
                      >
                        <div className="flex items-center justify-between">
                          <div className="flex items-center">
                            <svg className="shrink-0 h-6 w-6" viewBox="0 0 24 24">
                  ...
                  return (
                    <React.Fragment>
                      <a
                        ...
                        onClick={()=>{navigate('/owner/owner-chatList')}}
                      >
                        <div className="flex items-center justify-between">
                          <div className="flex items-center">
                            <svg className="shrink-0 h-6 w-6" viewBox="0 0 24 24">
