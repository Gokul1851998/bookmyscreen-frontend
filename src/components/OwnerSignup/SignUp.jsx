...
import { useNavigate } from 'react-router-dom'
 ...
 function SignUp() {
    ...
    const SignUpOTP=async(e)=>{
        ...
        if(password === cpassword){
            ...
            axios.post(`${ownerUrl}ownerOtp`, OwnerData).then((response)=>{
                response.data.ownerExist? toast.error('Owner Already Exist') : (setOwnerOtp(true))
            })
        }else{
    ...
    const verifyOtp =(e)=>{
      ...
      setLoading(true)
      console.log(otp);
      axios.post(`${ownerUrl}signUp`, { OwnerData, otp }).then((response)=>{
        response.data.status ? (navigate('/owner'), setOwnerOtp(false)) : toast.error('Incorrect otp')
      })
    }
  return (    
    <div>
        ...
        <div className="md:flex w-full">
          ...
          <div className="w-full md:w-1/2 py-10 px-5 md:px-10">
            ...
            <div className="flex -mx-3">
              ...
              <div className="flex -mx-3">
                <div className="w-full px-3 mb-1">
                  <label htmlFor className="text-xs font-semibold px-1">ID Proof (Adhaar Id)</label>
                  <div className="flex">
              ...
              <div className="flex -mx-3">
                <div className="w-full px-3 mb-1">
                  <label htmlFor className="text-xs font-semibold px-1">Theater licence Number</label>
                  <div className="flex">
