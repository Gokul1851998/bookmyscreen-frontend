...
import { useNavigate } from 'react-router-dom'
 ...
 function SignUp() {
    ...
    const [ownerOtp, setOwnerOtp] = useState(false);
    ...
    const SignUpOTP = async (e) => {
      ...
      if (password === cpassword) {
        setLoading(true)
        axios.post(`${ownerUrl}ownerOtp`, OwnerData).then((response) => {
          response.data.ownerExist
            ? toast.error('Owner Already Exist')
            : (setOwnerOtp(true), setLoading(false))
        }).catch(() => {
    ...
    const resendOtp = () => {
      setLoading(true)
      axios.post(`${ownerUrl}resendOtp`, { email }).then((response) => {
  ...
  return (    
    ...
    <div  className="min-w-screen min-h-screen bg-gray-900 flex items-center justify-center px-5 py-5">
      <div className="bg-gray-100 text-gray-500 rounded-3xl shadow-xl w-full overflow-hidden" style={{maxWidth: '1000px'}}>
        ...
        <div style={{backgroundImage:'url(https://img.freepik.com/free-photo/man-walking-street-during-night-time_413556-70.jpg?w=360&t=st=1681305187~exp=1681305787~hmac=93d869e59bb08bde2d40e539a27768ef7746f261ab7591d0c2f303bece650bb6'}} className="hidden md:block w-1/2 bg-indigo-500 py-10 px-10" >
          ...
          <div className="w-full md:w-1/2 py-10 px-5 md:px-10">
            <div className="text-center mb-10">
              <h1 className="font-bold text-3xl text-gray-900">Owner Register</h1>
              <p>Enter your information to register</p>
            </div>
            <form onSubmit={SignUpOTP}>
            <div>
            <div className="flex -mx-3">
                <div className="w-full px-3 mb-1">
                  <label  className="text-xs font-semibold px-1">Theatre Name</label>
                  <div className="flex">
                    ...
                    <input onChange={(e)=>setName(e.target.value)}  type="text" className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="johnsmith" />
                  </div>
                </div>
              </div>
              ...
              <div className="flex -mx-3">
                <div className="w-full px-3 mb-1">
                  <label  className="text-xs font-semibold px-1">Theater licence Number</label>
                  <div className="flex">
                    <div className="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i className="mdi  mdi-folder-account text-gray-400 text-lg" /></div>
                    <input onChange={(e)=>setLicence(e.target.value)}  type="text" className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="MH03 235698742" />
                  </div>
                </div>
              </div>
              <div className="flex -mx-3">
                <div className="w-full px-3 mb-1">
                  ...
                  <div className="flex">
                    <div className="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i className="mdi mdi-email-outline text-gray-400 text-lg" /></div>
                    <input onChange={(e)=>setPhone(e.target.value)}  type="number" className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="9400183831" />
                  </div>
                </div>
              </div>
              ...
              <div className="flex -mx-3">
                <div className="w-full px-3 mb-1">
                  ...
                  <div className="flex">
                    <div className="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i className="mdi mdi-email-outline text-gray-400 text-lg" /></div>
                    <input onChange={(e)=>setLocation(e.target.value)}  type="text" className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="Banglore" />
                  </div>
                </div>
              </div>
              <div className="flex -mx-3">
                <div className="w-full px-3 mb-1">
                  <label  className="text-xs font-semibold px-1">ID Proof (Adhaar Id)</label>
                  <div className="flex">
                    <div className="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i className="mdi  mdi-account-circle text-gray-400 text-lg" /></div>
                    <input onChange={(e)=>setAdhaar(e.target.value)} type="number" className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="1121 5689 2413" />
                  </div>
                </div>
              </div>
              <div className="flex -mx-3">
                <div className="w-full px-3 mb-1">
                  <label  className="text-xs font-semibold px-1">Upload Your ID Proof</label>
                  <div className="flex">
                    <div className="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i className="mdi mdi-email-outline text-gray-400 text-lg" /></div>
                    <input type="file" placeholder='ID Proof' onChange={(e)=>setImage(e.target.files[0])} className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500"  />
                  </div>
                </div>
              </div>
              <div className="flex -mx-3">
                <div className="w-full px-3 mb-1">
                  ...
                  <div className="flex">
                    ...
                    <input onChange={(e)=>setPassword(e.target.value)}  type="new-password" className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="************" />
                  </div>
                </div>
              </div>
              ...
              <div className="flex -mx-3">
                <div className="w-full px-3 mb-5">
                  ...
                  <div className="flex">
                    <div className="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i className="mdi mdi-lock-outline text-gray-400 text-lg" /></div>
                    <input onChange={(e)=>setCpassword(e.target.value)}  type="new-password" className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="************" />
                  </div>
                </div>
              </div>
              <div className="flex -mx-3">
        ...
        <>
          <div className="flex justify-center items-center overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none" >
            <div className="relative w-auto my-6 mx-auto max-w-3xl" >
              ...
              <form onSubmit={verifyOtp} className="bg-gray-200 shadow-md rounded px-8 pt-6 pb-8 w-full">
                ...
                <div className="flex items-start justify-center pb-6" >
                  <a className=" font-bold " onClick={resendOtp} >Resent</a>
                </div>
                </form>
              </div>
            </div>
